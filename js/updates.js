    ...
    var updates = [
        {
            ...
            menuDate: 'Sep 21',
            title: 'Week 23: twenty',
            isLatest: true,
            isSelected: true,
            img: '../img/OLAUpdate8.jpg',
            imgPos: '45% 50%',
            content: [{p:'Weeks to go: 3'}, {p:'Miles to go: 53!!!!'}, {p:'Long Run (This week): 20 miles'}, {p:'Donor Thank You’s:', cstyle:'cbold'}, {p:'Wahoo! Thanks so much for all of your help and kind words and support this week! I would like to thank the following people for their donations this week. I REALLY appreciate all of your support and prayers, for without you I wouldn’t be able to partake in this experience! Your contributions will benefit greatly for Team OLA and all of the wonderful opportunities we are trying to provide for the church:'}, {p:'- Nicole Campion', cstyle:'cindent'}, {p:'- Caroline Gould', cstyle:'cindent'}, {p:'- David Jones', cstyle:'cindent'}, {p:'- Mimi Huang', cstyle:'cindent'}, {p:'Reflection:', cstyle:'cbold'}, {p:'Ahaha! We have finally arrived to this point! I have finally conquered the day I have feared the most since I started this journey 23 weeks ago. Today I have finally answered the question that has plagued me since day one, which is “How on earth am I going to run 20 miles at one time?!?” But I did it! It’s over!! Wahhoooooooooo! Regardless of how excited I have been about my progress over the last handful of weeks, I have always feared this day in the back of my mind.'}, {p:'Why? ITS 20 MILES. AT ONE TIME. THAT’S WHY'}, {p:'There is something significantly different about conceptualizing even 19 miles and 20. For some reason, I could not wrap my mind around how I was going to approach this run, how it was going to feel or how I was going to do, which is silly considering I committed to running 26.2 not too long after that. But regardless I managed to face my fear this week and needless to say, I survived it. The key to success all along was something my dad told me from day 1: “One foot in front of the other.” It has been absolutely wonderful and encouraging to have him as my mentor and coach. For someone who has done this more than 8 times, his wisdom and experience has helped to guide me along the right path to strong and healthy running. All I have left now are three weeks of taper and the big day. These three weeks will be dedicated to rest, deep meditation on my goals and purpose and a whoooooole lot of stretching. But in the meantime, don’t forget to donate! Thanks for the support so far and you’ll hear from me soon.'}, {p:'Peace and Blessings,'}, {p:'CSR'}]
        },
        {
            date: 'September 14th, 2014',
            menuDate: 'Sep 14',
            title: 'Week 22: Almost there',
            isLatest: false,
            isSelected: false,
            img: '../img/churchrectory.jpg',
            imgPos: '30% 60%',
            content: [{p:'Weeks to go: 4'}, {p:'Miles to go: 87!!'}, {p:'Long Run (This week): 17 miles'}, {p:'Donor Thank You’s:', cstyle:'cbold'}, {p:'First off from the bottom of my heart I would like to thank the following people for donating up to this week. I really appreciate all of your support and prayers, for without you I wouldn’t be able to partake in this experience. I will be thinking of you during race day! Your contributions will benefit greatly for Team OLA and all of the wonderful opportunities we are trying to provide for the church:'}, {p:'- Teresa Blumenstein', cstyle:'cindent'}, {p:'- Eden Liu', cstyle:'cindent'}, {p:'Reflection:', cstyle:'cbold'}, {p:'Well I will admit that with these final 4 weeks closing in very fast, I haven’t much to report other than everything is going well and I am on pace to have a fantastic race day. I am healthy, excited, and anxious to close out 1 final week of long runs and go into the taper period leading up to the big day. It is especially times like this where I am filled with thanks to God for watching over me and carrying me through these 22 weeks. It has definitely been a long journey, with both spiritual highs and lows and I would definitely not be here without Him. God can reveal things to us in many different ways, and I have learned more about myself in these last 22 weeks than I have in any other concentrated stretch of time in my life. Now that He has showed me through my hard work that I can accomplish anything I put my entire self into, I will take these lessons and apply them to all aspects of life. I now know that I can bring about great good in other people’s lives and I will continue to find ways to do so after this is over. So I continue to thank all of you who have donated so far, but I encourage those who have not to please help me help others. The church does such great work for those in need and in supporting them, you are changing someone else’s life. Thanks for your consideration and until next week!'}, {p:'Peace and Blessings,'}, {p:'CSR'}]
        },
        {
